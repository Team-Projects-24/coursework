...
function BottomMenu({ selecting }: { selecting: boolean }) {
  ...
  return (
    <>
      <Grid
        container height={"100%"} className="second-colour"
        direction={"column"}
      >
        <Grid
          item container margin={0} paddingY={1} justifyContent={"center"}
          id="top-bar"
        >
          <Grid
            container item paddingY={1} borderRadius={3}
            className="main-colour" xs={11}
          >
          ...
          <Grid item paddingLeft={2} paddingTop={.8}>
            <Box padding={.3} className="icon-container">
